-- ══════════════════════════════════════════════════════════════════════════════
--  M2 WHAT-IF ENGINE — SCENARIO KPIs (before/after panel)
--
...
net AS (
  SELECT
    ...
    SUM(demand_obs   * 0.25)                         AS demand_observed_veh,
    SUM(d_lever      * 0.25)                         AS demand_lever_veh,
    SUM(demand_after * 0.25)                         AS demand_after_veh,
    SUM(offnetwork_vph * 0.25)                       AS demand_offnetwork_veh,
    SUM((demand_after + offnetwork_vph - d_lever) * 0.25) AS conservation_error_veh,
