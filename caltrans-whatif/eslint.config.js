...
export default tseslint.config(
  // Global ignores
  {
    ignores: [
      ...
      'tests/**',
      '**/.smoke-test/**',
      // Auto-generated by `appkit generate-types` (regenerated on every build, and the
      // header says DO NOT EDIT). It imports the full SQL marker union for use in the
      // query registry, so unused-import errors here are not actionable.
      'shared/appkit-types/**',
    ],
  },
